...
import { notebooksApi } from '@/modules/open-notebook/lib/api/notebooks'
...
export function useNotebooks(archived) {
  return useQuery({
...
export function useNotebookDeletePreview(id, enabled = false) {
  return useQuery({
