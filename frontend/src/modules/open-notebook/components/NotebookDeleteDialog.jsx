...
import { useNotebookDeletePreview, useDeleteNotebook } from '@/modules/open-notebook/lib/hooks/use-notebooks'
...
export function NotebookDeleteDialog({
  ...
  const [sourceAction, setSourceAction] = useState('keep')
            ...
            <>
              ...
              {preview.exclusive_source_count > 0 && (
                <div className="pt-3 border-t space-y-3">
                  ...
                  <RadioGroup
                    value={sourceAction}
                    onValueChange={(value) => setSourceAction(value)}
                    disabled={isDeleting}
                  >
