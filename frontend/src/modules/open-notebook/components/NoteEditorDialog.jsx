...
import { useCreateNote, useUpdateNote, useNote } from '@/modules/open-notebook/lib/hooks/use-notes'
import { QUERY_KEYS } from '@/modules/open-notebook/lib/api/query-client'
import { MarkdownEditor } from '@/components/ui/markdown-editor'
import { InlineEdit } from '@/components/common/InlineEdit'
import { cn } from "@/modules/open-notebook/lib/utils";
...
export function NoteEditorDialog({ open, onOpenChange, notebookId, note }) {
