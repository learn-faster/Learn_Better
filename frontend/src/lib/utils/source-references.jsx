 ...
 */
export function parseSourceReferences(text) {
 ...
 */
export function convertReferencesToMarkdownLinks(text) {
 ...
 */
export function convertReferencesToCompactMarkdown(text, referencesLabel = 'References') {
 ...
 */
export function convertSourceReferencesLegacy(text) {
